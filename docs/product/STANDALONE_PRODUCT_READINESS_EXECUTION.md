...
1. Product boundary spec
   - `docs/product/STANDALONE_PRODUCT_BOUNDARY.md`
2. Versioned standalone auth contract
   - `docs/api/STANDALONE_AUTH_CONTRACT_V1.md`
   - `docs/api/STANDALONE_AUTH_CONTRACT_V1.json`
...
5. Commercial packaging baseline
   - `docs/product/STANDALONE_COMMERCIAL_PACKAGING.md`
