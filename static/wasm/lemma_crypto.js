 ...
 * @returns {boolean}
 */
export function verify_signature_bytes(public_key, message, signature) {
 ...
 * @param {bigint | null | undefined} expires_at
 * @param {string} claims_json
 * @returns {Uint8Array}
 */
export function create_verification_message_debug(id, issuer, subject, issued_at, expires_at, claims_json) {
    ...
    const ret = wasm.create_verification_message_debug(ptr0, len0, ptr1, len1, ptr2, len2, issued_at, !isLikeNone(expires_at), isLikeNone(expires_at) ? BigInt(0) : expires_at, ptr3, len3);
