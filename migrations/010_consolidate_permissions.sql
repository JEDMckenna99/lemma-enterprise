...
-- Ensure the platform site exists for FK integrity
INSERT INTO sites (site_id, site_domain, company_name, admin_email, plan, api_key, oauth_client_id, oauth_client_secret)
VALUES ('lemma_platform', 'lemma.id', 'Lemma Platform', 'admin@lemma.id', 'internal', 'platform_key', 'platform_client', 'platform_secret')
...
INSERT INTO sites (site_id, site_domain, company_name, admin_email, plan, api_key, oauth_client_id, oauth_client_secret)
VALUES ('_template', 'template.example', 'Template', 'template@lemma.id', 'template', 'template_key', 'template_client', 'template_secret')
ON CONFLICT (site_id) DO NOTHING;
