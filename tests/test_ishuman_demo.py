...
def test_ishuman_demo_page_loads_expected_assets(ishuman_demo_client):
    ...
    assert "Your lemma.id stays with you. Each site gets a private ID." in body
    ...
    step3_start = body.index('id="ih-step-3"')
    ...
    assert "/static/js/demo/ishuman-demo.js?v=70" in body
    ...
    assert 'data-quick-act="1"' in body
    assert 'data-quick-act="2"' in body
