...
class LemmaDocumentRoot(Base):
    ...
    issuing_subdivision = Column(String(16), index=True)
    document_expiration_date = Column(String(10))
    date_of_birth = Column(String(255))  # encrypted at rest (YYYY-MM-DD)
    document_root_schema = Column(String(64), default='lemma.identity.document-root.v1')
