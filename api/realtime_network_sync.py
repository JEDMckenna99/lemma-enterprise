...
def receive_network_update():
    ...
    try:
        ...
        if update_type == 'revocation_update':
            # Apply revocation update instantly
            ...
            if credential_id:
                ...
                logger.info(f"🚫 Applied network revocation update: {credential_id[:8]}...")
        
        elif update_type == 'identity_lemma_update':
