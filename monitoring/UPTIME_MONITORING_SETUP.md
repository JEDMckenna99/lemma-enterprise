...
- Monitor Type: HTTP(S)
- Friendly Name: "Lemma IAM - Health"
- URL: `https://your-app.herokuapp.com/health`
- Monitoring Interval: 5 minutes
- Monitor Timeout: 30 seconds
- Alert When Down For: 5 minutes (1 check)

**Monitor 2: API Verification**
- Monitor Type: HTTP(S)
- Friendly Name: "Lemma IAM - API"
- URL: `https://your-app.herokuapp.com/api/v1/auth/verify`
- Monitoring Interval: 30 minutes
- HTTP Method: POST (keyword monitoring to check response)

**Monitor 3: Dashboard**
- Monitor Type: HTTP(S)
- Friendly Name: "Lemma IAM - Dashboard"
- URL: `https://your-app.herokuapp.com/dashboard`
...
- Public status page: `https://status.your-domain.com`
- Shows current uptime
- Incident history
- Good for transparency with customers
